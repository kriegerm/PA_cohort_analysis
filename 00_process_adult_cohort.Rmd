---
title: "Process reads: Adult Abscess"
...
here::i_am("00_process_adult_cohort.Rmd")
...
# 2.2 Remove any ASVs that were in the blanks: Skip for Adult because we don't have blanks
# 2.2 Instead, edit the metadata
```{r}
...
```{r}
filter_phyloseq(ps, "AdultAbscess", Contam_g, Contam_f, Contam_s)
```
...
saveRDS(list(ps_f=ps_f, 
             ps_fs= ps_fs), 
             file = paste0("00data_AdultAbscess.rds"))
```
