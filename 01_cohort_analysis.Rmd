...
### Species
```{r, fig.height=10, fig.width=7}
DA_results_df <- combine_DA(maaslin2_results_Species, ancombc2_results_df_Species, aldex2_res_Species, "Type", "Species",plot_colors=colors_all)
```
